            ...
            <div className="glass-card rounded-2xl overflow-hidden">
              ...
              <div className="p-4">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg font-medium hover:shadow-lg hover:shadow-green-500/25 transition-all duration-200"
                >
