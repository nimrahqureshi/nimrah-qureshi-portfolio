...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(res.message || 'Message sent! I will get back to you soon.');
    } catch (err) {
      const msg =
...
>
    {/* PRISMA INSPIRED LUXURY BACKGROUND */}
...
<div
  ...
  bg-[linear-gradient(to_right,#E1E0CC05_1px,transparent_1px),linear-gradient(to_bottom,#E1E0CC05_1px,transparent_1px)]
  bg-[size:5rem_5rem]
  [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_80%,transparent_100%)]
  pointer-events-none"
/>

{/* Ambient Lights */}
<div
  className="absolute top-1/3 right-1/4 w-[600px] h-[600px] bg-[#E1E0CC]/5 rounded-full blur-[140px] animate-pulse pointer-events-none"
  style={{ animationDelay: "1s" }}
/>

<div
  className="absolute bottom-1/3 left-1/4 w-[500px] h-[500px] bg-slate-800/40 rounded-full blur-[120px] animate-pulse pointer-events-none"
...
<div
  className="absolute top-12 right-12 w-1 h-1 bg-gray-400 rounded-full animate-float opacity-40"
  style={{ animationDelay: "0.8s" }}
/>

<div
  className="absolute bottom-48 right-36 w-2 h-2 bg-slate-600 rounded-full animate-float opacity-20"
  style={{ animationDelay: "1.8s" }}
/>

<div
  className="absolute bottom-12 left-16 w-1.5 h-1.5 bg-gray-500 rounded-full animate-float opacity-30"
      ...
      <div className="relative z-10 max-w-7xl px-6 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
           ...
           {/* Image + Contact Cards */}
<div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center mt-12">

  <div className="md:col-span-5 flex items-start justify-center relative">
  {/* Glow */}
  <div className="absolute w-56 h-56 rounded-full bg-[#E1E0CC]/10 blur-3xl" />
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-wrap gap-2.5 max-w-sm">
                ...
                <a
                  ...
                  title="GitHub"
                  aria-label="Nimrah Qureshi on GitHub"
                >
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-[#101010] border border-white/[0.03] flex items-center justify-center text-gray-400 hover:text-[#E1E0CC] hover:border-[#E1E0CC]/20 transition-all duration-300"
                  title="LinkedIn"
                  aria-label="Nimrah Qureshi on LinkedIn"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-[#101010] border border-white/[0.03] flex items-center justify-center text-gray-400 hover:text-[#E1E0CC] hover:border-[#E1E0CC]/20 transition-all duration-300"
                  title="Upwork"
                  aria-label="Nimrah Qureshi on Upwork"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-[#101010] border border-white/[0.03] flex items-center justify-center text-gray-400 hover:text-[#E1E0CC] hover:border-[#E1E0CC]/20 transition-all duration-300"
                  title="Fiverr"
                  aria-label="Nimrah Qureshi on Fiverr"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-[#101010] border border-white/[0.03] flex items-center justify-center text-gray-400 hover:text-[#E1E0CC] hover:border-[#E1E0CC]/20 transition-all duration-300"
                  title="Freelancer"
                  aria-label="Nimrah Qureshi on Freelancer"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-[#101010] border border-white/[0.03] flex items-center justify-center text-gray-400 hover:text-[#E1E0CC] hover:border-[#E1E0CC]/20 transition-all duration-300"
                  title="X"
                  aria-label="Nimrah Qureshi on X"
                >
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-[#101010] border border-white/[0.03] flex items-center justify-center text-gray-400 hover:text-[#E1E0CC] hover:border-[#E1E0CC]/20 transition-all duration-300"
                  title="Instagram"
                  aria-label="Nimrah Qureshi on Instagram"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-[#101010] border border-white/[0.03] flex items-center justify-center text-gray-400 hover:text-[#E1E0CC] hover:border-[#E1E0CC]/20 transition-all duration-300"
                  title="Pinterest"
                  aria-label="Nimrah Qureshi on Pinterest"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="contact-name" className="text-xs font-medium text-gray-400 uppercase tracking-wider">Your Name</label>
                    <input
                      id="contact-name"
                      type="text"
                      required
                  ...
                  <div className="space-y-2">
                    <label htmlFor="contact-email" className="text-xs font-medium text-gray-400 uppercase tracking-wider">Email Address</label>
                    <input
                      id="contact-email"
                      type="email"
                      required
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-white text-black hover:bg-[#E1E0CC] font-medium rounded-xl text-sm px-6 py-4 transition-all duration-300 flex items-center justify-center gap-2 group shadow-lg shadow-white/5 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {submitting ? (
                    <>
                ...
                {submitted && (
                  <p
                    role="status"
                    className="flex items-center gap-2 text-sm text-[#E1E0CC] bg-[#E1E0CC]/5 border border-[#E1E0CC]/15 rounded-xl px-4 py-3"
                  >
                    <CheckCircle2 className="w-4 h-4 flex-shrink-0" />
                    Thank you — your message is on its way. I usually reply within 24 hours.
                  </p>
                )}
              </form>
            </div>
