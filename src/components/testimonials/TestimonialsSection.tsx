            ...
            >
              <GlassCard className="bg-[#101010] rounded-2xl p-4 sm:p-5 md:p-6 h-full flex flex-col justify-between border border-white/[0.03] hover:border-white/[0.08] shadow-2xl group transition-all duration-300">
                <div>
                  ...
                  <Quote className="w-8 h-8 text-purple-400/30 mb-4 group-hover:text-purple-400/50 transition-colors duration-300" />
                ...
                <div>
                  <div className="text-xs text-purple-400 font-medium mb-4 tracking-wide uppercase">
                    {t.highlight}
                  </div>
          ...
          <GlassCard className="bg-[#101010] border border-white/[0.02] hover:border-white/[0.05] rounded-2xl md:rounded-[2rem] py-10 sm:py-14 md:py-16 px-6 sm:px-10 md:px-16 shadow-2xl transition-all duration-300">
            <div className="relative">
                  ...
                  {testimonials.map((_, i) => (
                    <button
                      ...
                      className={`h-1.5 rounded-full transition-all duration-300 ${
                        i === activeIndex ? 'bg-purple-400 w-6' : 'bg-white/10 w-1.5'
                      }`}
                    />
                  ))}
                </div>
              ...
              >
                ...
                <Quote className="w-10 h-10 text-purple-400/20 mx-auto mb-6" />
                
                <p className="text-base sm:text-lg md:text-xl text-[#E1E0CC] font-normal leading-relaxed mb-8 italic font-serif">
                  "{current.content}"
                </p>
                
                <div className="text-xs sm:text-sm text-purple-400 font-medium mb-6 tracking-wide uppercase">
                  {current.highlight}
                </div>
                ...
                <div className="flex items-center justify-center gap-3 pt-6 border-t border-white/[0.05] w-fit mx-auto">
                  {current.image ? (
                    ...
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-cyan-400 flex items-center justify-center text-white font-semibold shadow-lg">
