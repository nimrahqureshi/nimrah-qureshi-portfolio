...
const AIChatbot = lazy(() => import('@/components/chatbot/AIChatbot'));
...
export default function Layout() {
  ...
  return (
    <UIProvider>
      <div className="relative min-h-screen bg-black text-white overflow-x-hidden antialiased selection:bg-[#E1E0CC] selection:text-black">
        ...
        <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
          <motion.div
            ...
            className="absolute -top-40 -left-40 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-[#E1E0CC]/[0.05] to-transparent blur-[150px]"
          />
          <motion.div
            animate={{ scale: [1, 1.2, 1], opacity: [0.4, 0.7, 0.4] }}
            transition={{ duration: 15, repeat: Infinity, ease: 'easeInOut', delay: 2 }}
            className="absolute top-1/3 -right-20 w-[500px] h-[500px] rounded-full bg-gradient-to-l from-[#C8B68A]/[0.04] to-transparent blur-[130px]"
          />
