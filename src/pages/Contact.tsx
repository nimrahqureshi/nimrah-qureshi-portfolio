...
import { Mail, Linkedin, Github, MessageSquare, Loader2, Send } from 'lucide-react';
...
export default function Contact() {
  ...
  return (
    <div className="relative min-h-screen pt-24 pb-16 overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 pt-8">
        ...
        <div className="lg:col-span-5 space-y-6 text-left">
          <div className="space-y-2">
            ...
            <p className="text-gray-400 text-sm">Schedule architectural validation sessions or scope out autonomous business components natively.</p>
          </div>
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            {[
              { icon: Linkedin, url: 'https://www.linkedin.com/in/nimrah-qureshi-5a372b2bb' },
              { icon: Github, url: 'https://github.com/nimrahqureshi' },
              { icon: MessageSquare, url: 'mailto:nimrahqureshi013@gmail.com' }
            ].map((soc, i) => (
              <a 
                key={i} 
                href={soc.url} 
        ...
        <div className="lg:col-span-7">
          <form onSubmit={handleSubmit} className="premium-card p-6 sm:p-8 space-y-4 text-left bg-[#1E2023]/80">
            ...
            <div>
              <label className="block text-xs font-medium uppercase tracking-wider text-gray-400 mb-1.5 font-mono">Corporate Email Address</label>
              <input
                type="email"
            ...
            <div>
              <label className="block text-xs font-medium uppercase tracking-wider text-gray-400 mb-1.5 font-mono">Project Parameters / Scope Details</label>
              <textarea
                rows={4}
            ...
            <button
              type="submit"
              disabled={sending}
              className="w-full premium-btn-primary py-3.5 text-xs font-medium flex items-center justify-center gap-2 disabled:opacity-50 mt-2"
            >
